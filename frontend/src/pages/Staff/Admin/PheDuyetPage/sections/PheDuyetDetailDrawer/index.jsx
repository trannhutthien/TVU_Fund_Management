...
import styles from './PheDuyetDetailDrawer.module.scss';

const PheDuyetDetailDrawer = ({ record, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        ...
        role="dialog"
        aria-label="Chi tiết chuỗi phê duyệt"
      >
        {/* Header */}
...
PheDuyetDetailDrawer.propTypes = {
  record: PropTypes.object,
  onClose: PropTypes.func.isRequired,
};

export default PheDuyetDetailDrawer;
