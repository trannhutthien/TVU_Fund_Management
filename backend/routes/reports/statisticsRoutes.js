...
router.get('/ketoan/report', protect, authorizeRoles(1, 2), getKeToanReportStats);

// ─── APPLICATIONS (role 1 - admin) ─────────────────────────────────────────────
router.get('/applications/stats', protect, authorizeRoles(1), getApplicationStats);
router.get('/admin/advanced', protect, authorizeRoles(1), getAdminAdvancedStats);
